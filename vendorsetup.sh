...
rm -rf vendor/qcom/opensource/commonsys-intf/display && git clone https://github.com/SukeeratSG/vendor_qcom_opensource_display-commonsys-intf.git vendor/qcom/opensource/commonsys-intf/display
