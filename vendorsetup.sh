...
rm -rf hardware/qcom-caf/wlan && git clone https://github.com/SukeeratSG/android_hardware_qcom_wlan.git hardware/qcom-caf/wlan
...
# rm -rf git clone https://github.com/SukeeratSG/vendor_qcom_opensource_vibrator.git vendor/qcom/opensource/vibrator
